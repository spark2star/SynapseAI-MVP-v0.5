    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-neutral-600">Manage your account security and two-factor authentication</p>
            </div>
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-amber-800">MFA Not Enabled</h3>
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-green-800">MFA Enabled</h3>
                    ...
                    {showMFASetup && mfaSetup && (
                        <div className="space-y-6">
                            <div className="border-t pt-6">
                                <h3 className="text-lg font-medium text-neutral-900 mb-4">Setup Authenticator App</h3>
                                
                                {/* Step 1: QR Code */}
                                <div className="space-y-4">
                                    <div className="p-4 bg-neutral-50 rounded-lg">
                                        <h4 className="font-medium text-neutral-900 mb-2">Step 1: Scan QR Code</h4>
                                        ...
                                        <div className="mt-4 p-3 bg-neutral-100 rounded text-center">
                                            <p className="text-xs text-neutral-600">Manual entry key:</p>
                                    ...
                                    {/* Step 2: Verification */}
                                    <div className="p-4 bg-neutral-50 rounded-lg">
                                        <h4 className="font-medium text-neutral-900 mb-2">Step 2: Verify Setup</h4>
                                        <p className="text-sm text-neutral-600 mb-4">
                                    ...
                                    <div className="p-4 bg-blue-50 rounded-lg">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 font-mono text-sm bg-white p-3 rounded border">
                                            {mfaSetup.backup_codes.map((code, index) => (
                                                <div key={index} className="text-center p-1 bg-neutral-50 rounded">
                                                    {code}
                                                </div>
                                            ))}
                                        </div>
            ...
            <div className="medical-card">
                <div className="p-6">
                    <h2 className="text-lg font-semibold text-neutral-900 mb-4">Account Security</h2>
                    
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                            <div>
                                <h3 className="text-sm font-medium text-neutral-900">Password</h3>
                                <p className="text-sm text-neutral-600">Last changed: Never</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                            <div>
                                <h3 className="text-sm font-medium text-neutral-900">Session Management</h3>
                                <p className="text-sm text-neutral-600">Manage active sessions</p>
                            </div>
                            <Button variant="secondary" size="sm">
                                View Sessions
                            </Button>
